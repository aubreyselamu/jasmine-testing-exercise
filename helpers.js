...
function sumPaymentTotal(type) { //What does type do?
  let total = 0;
...
function calculateTipPercent(billAmt, tipAmt) {
  return Math.round(100 / (billAmt / tipAmt)); //is this wrong? It should be tipAmt/billAmt. what does the 100 at the beginning do?
}
